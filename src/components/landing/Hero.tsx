      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          ...
          <motion.div 
            ...
            className="inline-flex items-center rounded-full border border-primary/20 bg-primary/5 px-3 py-1 text-sm font-medium text-primary backdrop-blur-sm mb-8"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-foreground via-foreground/90 to-foreground/50 pb-4"
          >
            {text.headline} <br />
          ...
          <motion.div 
            ...
            className="mt-20 relative w-full max-w-5xl rounded-xl border border-border/40 bg-zinc-950/50 shadow-2xl overflow-hidden backdrop-blur-sm"
          >
             {/* Mock Browser Header */}
